...
- [ ] **Placeholders de ejemplo genéricos, no información real**: el campo "Responsable" en Clientes tiene `placeholder="Ej: Christian"` (nombre real de una persona) — cambiar por un ejemplo genérico/aleatorio. Repasar el resto de los placeholders del sistema por si hay otros casos parecidos.
